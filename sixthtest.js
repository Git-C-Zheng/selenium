...
async function example() {
  ...
  console.log(
    "object view",
    driver.findElement(By.xpath('//*[@id="create-new-vault__terms-checkbox"]'))
  );
  //////////////////////////////////////////////////////
  ...
  await driver
    ...
    .then(
      ...
      (error) => {
        ...
        // else {
        //     driver.findElement(By.id('//*[@id="app-content"]/div/div[2]/div/div[3]/div[2]/button[2]')).click();
        // }
      }
    );

  // driver.findElement().then(function(webElement) {
...
//       : "2"
//   );
  // console.log("type",typeof((driver.findElement(By.xpath('//*[@id="app-content"]/div/div[2]/div/div[3]/div[2]/button[2]')))))
